...
```
docker run --rm -p 3030:3030 -v $(pwd):/usr/share/data atomgraph/fuseki --file=/usr/share/data/musician_network.owl /ds
```

This example line uses the `musician_network.owl` ontology file, but do replace this with the name of your ontology file, should it be named differently for any reason.
